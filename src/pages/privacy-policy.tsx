      ...
      <div className="prose max-w-none">
        ...
        <div className="bg-gray-100 p-4 rounded-lg my-6">
          <p>
            ...
            when you use Notion Avatar. The short version: we process your
            images directly in your browser and don't store them on our servers.
          </p>
        </div>
        ...
        <ul className="list-none pl-5 mb-6 space-y-4">
          <li className="relative pl-6">
            ...
            <strong className="text-black">Usage Data:</strong> We use analytics
            tools to collect anonymous information about how users interact with
        ...
        <div className="mt-12">
          ...
          <ul className="list-none space-y-4 mb-6">
            <li className="relative pl-6 text-gray-700">
              ...
              use Google Analytics to understand user behavior. Google Analytics
              may collect information about your device, browsing session, and
              how you interact with our site. You can learn more about Google
              Analytics' privacy practices at Google's Privacy Policy.
            </li>
            <li className="relative pl-6 text-gray-700">
              <span className="absolute left-0 text-gray-500">•</span>
